...
public class QPolicy {
    ...
    //不带 epsilon-greedy 的 q-learning 方法，根据当前状态的可能动作的 Q
    // 值来选取动 作，用在利用阶段，即真正决策的阶段。
    ...
    //带 epsilon-greedy 的 q-learning 方法，即有一定概率不选取最大 Q 值来决定下一步而是随机
    // 走一步，这么做是为了避免程序在一块很小的区域内打转，用在探索阶段，探索尽可能多的状态，
    // 得到更精 确的状态与 Q 值的映射，即使 Q 值更收敛于真实值
