...
public class SimpleStateHeuristic extends StateHeuristic {
    ...
    public double evaluateState(StateObservation stateObs) {
        ...
        double won=0;
        double score=0;
        if(stateObs.getGameWinner()==Types.WINNER.PLAYER_WINS) won=1000000;
        else if(stateObs.getGameWinner()==Types.WINNER.PLAYER_LOSES) won=-9999999;
        ...
        //caculate score
        if(movingDist==0)
            score= stateObs.getAvatarHealthPoints()+stateObs.getGameScore()+won-protalDist*100-9999+immovingDist;
        else
            score= stateObs.getAvatarHealthPoints()+stateObs.getGameScore()+won-protalDist*100+movingDist*10+immovingDist;
        return score;
    }
